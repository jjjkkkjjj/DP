...
class ContextDP(DP):
    ...
    def sync(self, myMatchingCostFunc=None, myLocalCosts=None, returnMatchingCosts=False):
        self.correspondents = {}
    ...
    def syncCorrespondInitial(self, myMatchingCostFunc=None):
        ...
        matchingCosts = self.sync(myMatchingCostFunc=myMatchingCostFunc, myLocalCosts=myLocalCosts,
